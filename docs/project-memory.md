...
| ID | 内容 | 状況 |
|---|---|---|
| **T-01** | **OpenAI API キーを再発行する** | ⚠️ **未完了**。過去にフロントのビルド成果物・git履歴・チャットへ露出。漏洩したものとして扱い、必ず Revoke → 再発行 |
| **T-02** | git 履歴からシークレットを除去する | ⚠️ **未完了**。手順は `docs/secret-removal.md` |
